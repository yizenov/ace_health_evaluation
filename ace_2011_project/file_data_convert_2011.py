...
col_info_file_path = home + "/Downloads/ICGE_course/project/project_ace_python/ace_2011_project/"
col_info_file = "col_extract_info_2011.txt"
...
file_path = home + "/Downloads/ICGE_course/project/LLCP2011ASC/"
file_name = "LLCP2011.ASC"

output_csv_file = "parsed_ace_data_2011.csv"
fieldnames = [i for i in range(1, len(column_values) + 1)]

temp_file = "temp.txt"
with open(col_info_file_path + temp_file, 'w') as tempfile:
